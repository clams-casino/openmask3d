...
import numpy as np
from openmask3d.data.load import Camera, InstanceMasks3D, Images, OpenSceneMatterportPointCloud, get_number_of_images
...
def main(ctx: DictConfig):
    ...
    pointcloud = OpenSceneMatterportPointCloud(ctx.data.point_cloud_path)
